...
// Second equation
  ...
  block PIDControllerBlock
    ...
    parameter Real K_p = 1 "The proportional gain of the PID controller";
    parameter Real K_i = 1 "The integral gain of the PID controller";
    parameter Real K_d = 1 "The derivative gain of the PID controller";
