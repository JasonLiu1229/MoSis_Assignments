...
// Second equation
  ...
  block CraneModelBlock
    ...
    Modelica.Blocks.Interfaces.RealOutput x_output "Output signal x connector" annotation(
      Placement(transformation(origin = {-10, 40}, extent = {{100, -10}, {120, 10}}), iconTransformation(origin = {0, 50}, extent = {{100, -10}, {120, 10}})));
    Modelica.Blocks.Interfaces.RealOutput theta_output "Output signal theta connector" annotation(
      Placement(transformation(origin = {-10, -40}, extent = {{100, -10}, {120, 10}}), iconTransformation(origin = {0, -50}, extent = {{100, -10}, {120, 10}})));
  equation
    u = u_input;
    x_output = x;
