...
class PIDCLBlock(CBD):
    def __init__(self, block_name):
        ...
        self.addBlock(ConstantBlock("IC_d", value=(0)))
        self.addBlock(ConstantBlock("IC_i", value=(0)))
        self.addBlock(ProductBlock("dqvIs03bip9LbBkwujtJ-2", numberOfInputs=(2)))
        self.addBlock(ConstantBlock("K_i", value=(1)))
        self.addBlock(ConstantBlock("K_d", value=(10)))
        self.addBlock(ProductBlock("dqvIs03bip9LbBkwujtJ-76", numberOfInputs=(2)))
        ...
        self.addConnection("IC_i", "DzCg6ToobE1hvCms1og_-13", output_port_name='OUT1', input_port_name='IC')
        self.addConnection("IC_d", "DzCg6ToobE1hvCms1og_-17", output_port_name='OUT1', input_port_name='IC')
        ...
        self.addConnection("DzCg6ToobE1hvCms1og_-13", "dqvIs03bip9LbBkwujtJ-2", output_port_name='OUT1', input_port_name='IN1')
        self.addConnection("dqvIs03bip9LbBkwujtJ-2", "DzCg6ToobE1hvCms1og_-21", output_port_name='OUT1', input_port_name='IN2')
        self.addConnection("K_i", "dqvIs03bip9LbBkwujtJ-2", output_port_name='OUT1', input_port_name='IN2')
        self.addConnection("DzCg6ToobE1hvCms1og_-17", "dqvIs03bip9LbBkwujtJ-76", output_port_name='OUT1', input_port_name='IN1')
        self.addConnection("K_d", "dqvIs03bip9LbBkwujtJ-76", output_port_name='OUT1', input_port_name='IN2')
        self.addConnection("dqvIs03bip9LbBkwujtJ-76", "DzCg6ToobE1hvCms1og_-25", output_port_name='OUT1', input_port_name='IN2')
